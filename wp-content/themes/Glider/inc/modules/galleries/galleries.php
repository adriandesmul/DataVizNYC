...
class crum_galleries_widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'crum_galleries_widget',
            __( 'Box: Galleries','crum'), // Name
            array( 'description' => __( 'Display Galleries thumbnails','crum'),
            )
        );
    }
    ...
    function widget( $args, $instance ) {
        ...
        echo '<div class="row recent-projects-block">';
        ...
        while ( $the_query->have_posts() ) :
            ...
            <div class="three columns">
                ...
                if( has_post_thumbnail() ){
                    ...
                    $article_image = $no_image; //TODO: Set no-image
                } ?>
...
add_action( 'widgets_init', create_function( '', 'register_widget("crum_galleries_widget");' ) );