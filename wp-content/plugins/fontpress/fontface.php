...
<div class="wrap fp_form lcwp_form"> 
	...
	if(isset($_POST['fp_ul_font'])) { 
		...
		$indexes[] = array('index'=>'ul_font', 'label'=>__( 'Font Upload', 'fp_ml' ), 'ul_required'=>true, array('application/zip'));

		$validator->formHandle($indexes);
		$fdata = $validator->form_val;
		
		// zip package upload
		if($_FILES['ul_font']['type'] == 'application/zip' || $_FILES['ul_font']['type'] == '"application/x-zip"') {
...
<?php // SCRIPTS ?>
<script src="<?php echo FP_URL; ?>/js/iphone_checkbox/iphone-style-checkboxes.js" type="text/javascript"></script>
