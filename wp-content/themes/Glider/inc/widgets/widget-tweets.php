    ...
    public function widget($args, $instance) {
        ...
        if(!empty($tp_twitter_plugin_tweets)){
            ...
            echo '<div class="tweets-author">
                 <img src="'.$image.'" alt="" />
                 <strong> '.$instance['username'].'</strong> '; ?>
            ...
            foreach($tp_twitter_plugin_tweets as $tweet){
                print '<div class="tweet">'.convert_links($tweet['text']).'<div class="time">'.relative_time($tweet['created_at']).'</div></div>';
